...
% successful solution indicated by cost function with a magnitude of 1e-6
% or so
...
dP1 = sqrt((endx(1)-px(1))^2+(endy(1)-py(2))^2+(endz(1)-pz(3))^2)
dP2 = sqrt((endx(2)-px(1))^2+(endy(2)-py(2))^2+(endz(2)-pz(3))^2)
dP3 = sqrt((endx(3)-px(1))^2+(endy(3)-py(2))^2+(endz(3)-pz(3))^2)
